...
const ShowErrMess = ()=>{
    ...
    let capture = isWebcamCapture == true ? getImg : employee.profileimage;
                    ...
                    <>
                        <Grid container spacing={2}>
                            ...
                            <Grid item lg={3} md={3} sm={4} xs={12}>
                                ...
                                {croppedImage && (
                                    <>
                                        <img style={{ height: 120 }} src={croppedImage} alt="Cropped" />
                                    </>
                                )}
                                <div>
                                    {selectedFile ? (
    ...
    const renderStepFour = () => {
        return (
            <>
                ...
                <Box >
                    <Button onClick={(e) => { handleDraftSubmit(e); }} > Draft </Button>
                    <Button className="next" variant="contained" onClick={nextStep}>Next</Button>
                </Box>
            </Box>
            </>
