...
function MultistepForm() {
    ...
    const [employee, setEmployee] = useState({
        ...
        bloodgroup: "", profileimage: "", location: "", email: "", contactpersonal: "", contactfamily: "", emergencyno: "", doj: "", dot: "", name: "", contactno: "", details: "", username: "",referencename:"",
        password: "", companyname: "", pdoorno: "", pstreet: "", parea: "", plandmark: "", ptaluk: "", ppost: "", ppincode: "", pcountry: "", pstate: "", pcity: "",
        cdoorno: "", cstreet: "", carea: "", clandmark: "", ctaluk: "", cpost: "", cpincode: "", ccountry: "", cstate: "", ccity: "", branch: "", floor: "", department: "",
    ...
    console.log(selectedCountryp.name);
    console.log(selectedCountryc.name);
    ...
    const handleSubmittodo = (e) => {
        const errorstodo = {};
        e.preventDefault();
        if(qualification == "", institution == "", passedyear == "", cgpa == ""){
            errorstodo.qualification = <Typography style={{ color: 'red' }}>Please Enter All Fields</Typography>;
    ...
    const handleSubmitAddtodo = (e) => {
        const errorstodo = {};
        e.preventDefault();
        if(addQual == "", addInst == "", duration == "", remarks == ""){
            errorstodo.addQual = <Typography style={{ color: 'red' }}>Please Enter All Fields</Typography>;
            setErrorstodo(errorstodo);
        }else{
    ...
    const handleSubmitWorkSubmit = (e) => {
        ...
        errorstodo.empNameTodo = <Typography style={{ color: 'red' }}>Please Enter All Fields</Typography>;
            setErrorstodo(errorstodo);
        }else{
    ...
    // Unit Dropdowns
    const fetchUnitNames = async (branch) => {
        try {
...
const ShowErrMess = ()=>{
    ...
    // Branch Dropdowns
    const fetchbranchNames = async (e) => {
        try {
...
console.log(month,'omonth')
    //Submit function for sending email
    const handleEmailSubmit = (e) => {
        e.preventDefault();
        setStatus('Sending...');
        setUserNameEmail(third)
        fetch('http://192.168.85.8:7001/send-email', {
            method: 'POST',
    ...
    let companycaps = ((employee.firstname).toUpperCase() + '.' + (employee.lastname).toUpperCase());
                                    ...
                                    <Grid item md={9} sm={9} xs={9}>
                                        <FormControl size="small" fullWidth>
                                            <OutlinedInput
                                                ...
                                                onChange={(e) => {
                                                    fetchUserName();
                                                    setFirst((e.target.value).toLowerCase()); setEmployee({ ...employee, firstname: (e.target.value).toUpperCase(), prefix: employee.prefix })
                                                }}
                                            />
                                        </FormControl>
                            ...
                            <Grid item md={6} sm={12} xs={12}>
                                <FormControl fullWidth size="small">
                                    ...
                                    <OutlinedInput
                                        ...
                                        onChange={(e) => {
                                            fetchUserName(); setSecond((e.target.value).toLowerCase())
                                            setUserName({ ...userName, fname: ((employee.firstname).toLowerCase() + ((e.target.value).slice(0, 1)).toLowerCase()), length: (((employee.lastname).slice(0, 1)).length) }); setEmployee({ ...employee, lastname: (e.target.value).toUpperCase() })
                                        }}
                                    />
                                </FormControl>
                                        ...
                                        <Grid item md={4}>
                                            <FormControl fullWidth size="small">
                                                ...
                                                <TextField
                                                    ...
                                                    onChange={(e) => { setEmployee({ ...employee, email: e.target.value }); setIsValidEmail(validateEmail(e.target.value)); setEmail(e.target.value); }} 
                                                    InputProps={{
                                                        inputProps: {
                                                            pattern: /^\S+@\S+\.\S+$/,
                                                        },
                        ...
                        <Grid item md={4} sm={12} xs={12}>
                            <FormControl size="small" fullWidth>
                                ...
                                <OutlinedInput
                                    ...
                                    onChange={(e) => { setEmployee({ ...employee, password: e.target.value }); setUserPassword(e.target.value);}}
                                />
                            </FormControl>
                        ...
                        <Grid item md={4} sm={12} xs={12}>
                            <FormControl fullWidth size="small" >
                                ...
                                <Select
                                    ...
                                    onChange={(e, i) => {
                                        setEmployee({ ...employee, branch: e.target.value }); fetchUnitNames(e.target.value);
                                    }}
                                >
                                    {branchNames &&
                                        branchNames.map((row) => (
