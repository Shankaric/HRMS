...
function Subpage5() {
    ...
    const [subpagefive, setSubpagefive] = useState({project: "", subproject: "", module: "", name: "", submodule: "", mainpage: "", subpageone: "",subpagetwo:"",estimation:"",estimationtime:"Year",
    subpagethree:"",subpagefour:""})
    const [subid, setSubid] = useState({project: "", subproject: "", module: "", name: "", submodule: "", mainpage: "", subpageone: "",subpagetwo:"",estimation:"",estimationtime:"Year",
    subpagethree:"",subpagefour:""});
    ...
    const [subpagefives, setSubpagefives] = useState([])
    ...
    const[subPageFourList , setSubPagefourList] = useState([]);
    ...
    const fetchSubProjectDropdowns = async (e) => {
        try {
            ...
            //fetching subpage four for Dropdowns
            const fetchSubPageFourDrop = async () => {
                try {
                    let projectDrop = await axios.get(SERVICE.SUBPAGESFOUR);
                    setSubPagefourList(projectDrop.data.subpagesfour);
    ...
    const fetchMainPageDropdownsedit = async () => {
      ...
      //fetching Sub-Page-1 Dropdowns
        ...
        const fetchSubPage2Dropdowns = async (subPage1) => {
          ...
          const [getsubpage1name, setgetsubpage1name] = useState("")
            ...
            const fetchSubPage2Dropdownsedit = async () => {
                let subPage1 = getsubpage1name ? getsubpage1name : subid.subpageone;;
        ...
        const fetchSubPage3Dropdownsedit = async () => {
            let subPage2 = getsubpage2name ? getsubpage2name : subid.subpagetwo;
            try {
                    let subpag1 = await axios.get(SERVICE.SUBPAGESTHREE);
                    let subPag1Drop= subpag1.data.subpagesthree.filter((data) => {
                        if (subPage2 === data.subpagetwo)      
    ...
    const fetchSubPage4Dropdownsedit = async () => {
        let subPage3 = getsubpage3name ? getsubpage3name : subid.subpagethree;
    ...
    //get all subpagefive.
    const fetchAllSubpagefive = async () => {
        try {
            let res_subfour = await axios.get(SERVICE.SUBPAGESFIVE, {
            });
            setSubpagefives( res_subfour.data.subpagesfive);
        } catch (err) {
            const messages = err.response.data.message;
            console.log(messages)
        }
    ...
    const rowData = async (id) => {
        try {
            let res = await axios.get(`${SERVICE.SUBPAGEFIVE_SINGLE}/${id}`, {
                // headers: {
                //     'Authorization': `Bearer ${auth.APIToken}`
                // }
            });
            setDeletemainpage(res.data.ssubpagefive);
        } catch (err) {
        }
    }
    ...
    const delMainpage = async () => {
        try {
            await axios.delete(`${SERVICE.SUBPAGEFIVE_SINGLE}/${mainpageid}`, {
                // headers: {
                //     'Authorization': `Bearer ${auth.APIToken}`
                // }
            });
    ...
    const sendRequest = async () => {
        try {
            let subpagescreate = await axios.post(SERVICE.SUBPAGEFIVE_CREATE, {
                // headers: {
                //     'Authorization':`Bearer ${auth.APIToken}`
                //     }
                project: String(subpagefive.project),
                subproject: String(subprojectnone.name === "None" ? "None" : subpagefive.subproject),
                module: String(subpagefive.module),
                submodule: String(submodulenone.name === "None" ? "None" : subpagefive.submodule),
                mainpage: String(subpagefive.mainpage),
                name: String(subpagefive.name),
                subpageone: String(subpagefive.subpageone),
                subpagetwo: String(subpagefive.subpagetwo),
                subpagethree: String(subpagefive.subpagethree),
                subpagefour: String(subpagefive.subpagefour),
                estimation: String(subpagefive.estimation),
                estimationtime: String(subpagefive.estimationtime) ? subpagefive.estimationtime : "Year",
                addedby: [
                    {
            ...
            setSubpagefive(subpagescreate.data)
            setSubpagefive({ project: "", subproject: "", module: "", submodule: "", name: "", mainpage: "",subpageone:"",subpagetwo:"",subpagethree:"",estimation: "", estimationtime: "" })
        } catch (error) {
            setShowAlert(
                <>
    ...
    const getCode = async (e) => {
        ...
        let res = await axios.get(
            `${SERVICE.SUBPAGEFIVE_SINGLE}/${e}`,
            {}
        );
        setSubid(res.data.ssubpagefive);
        setRowGetid(res.data.sprojectdetails);
        setRowEditTime(res.data.ssubpagefive);
    };
    // get single row to view....
    const getviewCode = async (e) => {
        let res = await axios.get(`${SERVICE.SUBPAGEFIVE_SINGLE}/${e}`, {});
        setSubid(res.data.ssubpagefive);
    };
    ...
    const sendEditRequest = async () => {
        try {
            let res = await axios.put(`${SERVICE.SUBPAGEFIVE_SINGLE}/${suboneid}`, {
                ...
                subpagefour: String(subid.subpagefour),
    ...
    const fetchTimeDiffCal = async (projName) => {
        try {
            ...
            let sub_proj_time = subpagefives.map((data) => {
                if (projName === data.subpagefour) {
            ...
            let project_check = subpage4.map((value) => {
    ...
    let timeDiffsEdit=0;
       ...
       const fetchEditEstTime = async ()=>{
        try{
            let sub_Project = editProjDropdwon ?  editProjDropdwon : rowEditTime.subpagefour;
            let sub_proj_time = subpagefives.filter((data)=>{
    
                if(sub_Project === data.subpagefour){
            ...
            else if (sub_Project != data.subpagefour){
                setEditTimeCalculation(ansEdit);
           ...
           let project_check = subPageFourList.map((value)=>{
    ...
    console.log(editTimeCalculation , 'edit')
    const modifiedData = subpagefives.map((person) => ({
        ...person,
      ...
      const columns = [
        ...
        { title: "Subapgefour", field: "subpagefour" },
    ...
    const downloadPdf = () => {
        ...
        doc.save('subpage-5.pdf')
    }

    // Excel
    const fileName = "Subpage-5";
    ...
    const totalPages = Math.ceil(subpagefives.length / pageSize);
    ...
    return (
        <Box>
            {/* ****** Header Content ****** */}
            <Typography sx={userStyle.HeaderText}>Sub Page 5 </Typography>
            <Box sx={userStyle.container}>
                <>
                    <Grid container spacing={2}>
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>Manage Sub Page 5</Typography>
                        </Grid>
                    </Grid><br />
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <Select
                                    ...
                                    value={subpagefive.project}
                                    onChange={(e, i) => {
                                        setSubpagefive({ ...subpagefive, project: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.subproject}
                                    onChange={(e, i) => {
                                        setSubpagefive({ ...subpagefive, subproject: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.module}
                                    onChange={(e, i) => {
                                        setSubpagefive({ ...subpagefive, module: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.submodule}
                                    onChange={(e, i) => {
                                        setSubpagefive({ ...subpagefive, submodule: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.mainpage}
                                    onChange={(e, i) => {
                                        setSubpagefive({ ...subpagefive, mainpage: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl fullWidth size="small">
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.subpageone}
                                    onChange={(e) => {
                                        setSubpagefive({ ...subpagefive, subpageone: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl fullWidth size="small">
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.subpagetwo}
                                    onChange={(e) => {
                                        setSubpagefive({ ...subpagefive, subpagetwo: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl fullWidth size="small">
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.subpagethree}
                                    onChange={(e) => {
                                        setSubpagefive({ ...subpagefive, subpagethree: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <FormControl fullWidth size="small">
                                <Select
                                    labelId="demo-select-small"
                                    id="demo-select-small"
                                    value={subpagefive.subpagefour}
                                    onChange={(e) => {
                                        setSubpagefive({ ...subpagefive, subpagefour: e.target.value });
                        ...
                        <Grid item md={4} xs={12} sm={12}>
                            <FormControl fullWidth size="small" >
                                ...
                                <OutlinedInput
                                    ...
                                    type="text"
                                    value={subpagefive.name}
                                    onChange={(e) => { setSubpagefive({ ...subpagefive, name: e.target.value }) }}
                                />
                            </FormControl>
                        </Grid>
                        <Grid item md={4} xs={12} sm={12}>
                            ...
                            <Grid item md={6} xs={12} sm={12}>
                                    ...
                                    <FormControl fullWidth size="small" >
                                        <OutlinedInput
                                            id="component-outlined"
                                            type="number"
                                            value={subpagefive.estimation}
                                            onChange={(e) => { setSubpagefive({ ...subpagefive, estimation:Number(e.target.value) > typeEst ? "" : Number(e.target.value) }) }}
                                        />
                                    </FormControl>
                                    {subpagefive.estimationtime ?
                        <Typography sx={{ color: "red" }}> {typeEst} {subpagefive.estimationtime} is Remaining </Typography> : " "}
                                </Grid>
                                <Grid item md={6} xs={12} sm={12}>
                                <Typography>Time</Typography>
                                    <Select
                                        ...
                                        labelId="demo-select-small"
                                        id="demo-select-small"
                                        value={subpagefive.estimationtime}
                                        onChange={(e) => { setSubpagefive({ ...subpagefive, estimationtime: e.target.value });
                    ...
                    <Box sx={userStyle.dialogbox}>
                        ...
                        <Grid item md={6} xs={12} sm={12}>
                            ...
                            <Select
                                            labelId="demo-select-small"
                                            id="demo-select-small"
                                            value={subid.subpagefour}
                                            onChange={(e) => {
                                                setSubid({ ...subid, subpagefour: e.target.value });
            ...
            <>
                <Box sx={userStyle.container}>
                    { /* ******************************************************EXPORT Buttons****************************************************** */}
                    <Grid item xs={8}>
                        <Typography sx={userStyle.importheadtext}>Sub Page-5 List</Typography>
                    </Grid>
                    ...
                    <Grid style={userStyle.dataTablestyle}>
                        <Box>4
                            ...
                            <MenuItem value={(subpagefives.length)}>All</MenuItem>
                            </Select>
                        </Box>
                        <Box>
                            <FormControl fullWidth size="small" >
                        ...
                        >
                            <TableHead sx={{ fontWeight: "600" }}>
                                ...
                                <StyledTableCell onClick={() => handleSorting('serialNumber')}><Box sx={userStyle.tableheadstyle}><Box>SNo</Box><Box sx={{marginTop:'-6PX'}}>{renderSortingIcon('serialNumber')}</Box></Box></StyledTableCell>
                                        ...
                                        <StyledTableCell onClick={() => handleSorting('subpagefour')}><Box sx={userStyle.tableheadstyle}><Box>Subpagefour Name</Box><Box sx={{marginTop:'-6PX'}}>{renderSortingIcon('subpagefour')}</Box></Box></StyledTableCell>
                                    ...
                                    filteredData?.map((row, index) => (
                                        <StyledTableRow key={index}>
                                            ...
                                            <StyledTableCell>{row.subpagefour}</StyledTableCell>
                                ...
                                <Box style={userStyle.dataTablestyle}>
                                    <Box>
                                        Showing {((page - 1) * pageSize) + 1} to {Math.min(page * pageSize, subpagefives.length)} of {subpagefives.length} entries
                                    </Box>
                                    <Box>
                            ...
                            {subpagefives &&
                                (subpagefives.map((row, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>{row.subpagefour}</TableCell>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item md={6} xs={12} sm={12} >
                                <FormControl fullWidth size="small">
                                    ...
                                    <Typography>{subid.subpagefour}</Typography>
                                </FormControl>
                            </Grid>
